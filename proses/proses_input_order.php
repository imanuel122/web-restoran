...
//cek kode order sudah ada atau belum
$query = "SELECT id_order FROM tbl_order WHERE id_order = '$kode_order'";
        ...
        <div class="row justify-content-center align-items-center" style="height: 100vh;">
            <div class="col-6 text-center">
                <div class="alert alert-danger d-flex align-items-center justify-content-center" role="alert"
                    style="height: 300px;">
                    <div>
                        <p class="fw-semibold mb-4" style="font-size: 18px;">Gagal, order yang dimasukkan sudah ada!</p>
...
if (isset($_POST['buat_order'])) {
    ...
    $query = "INSERT INTO tbl_order (`id_order`, `pelanggan`, `meja`, `id`) VALUES ('$kode_order', '$nama_pelanggan', '$meja', '$_SESSION[id_cafe]')";
    $result = mysqli_query($conn, $query);
    if (mysqli_affected_rows($conn)) {
            ...
            <div class="row justify-content-center align-items-center" style="height: 100vh;">
                <div class="col-6 text-center">
                    <div class="alert alert-success d-flex align-items-center justify-content-center" role="alert"
                        style="height: 300px;">
                        <div>
                            <p class="fw-semibold mb-4" style="font-size: 18px;">Success, order baru berhasil ditambahkan!</p>
        ...
        // echo '<script> 
        //             alert("Order baru gagal ditambahkan");
        //             document.location.href = "index.php";
        //             window.location="../order"; 
        //         </script>';
            ...
            <div class="row justify-content-center align-items-center" style="height: 100vh;">
                <div class="col-6 text-center">
                    <div class="alert alert-danger d-flex align-items-center justify-content-center" role="alert"
                        style="height: 300px;">
                        <div>
                            <p class="fw-semibold mb-4" style="font-size: 18px;">Gagal, order baru gagal ditambahkan!</p>
                            <a href="../order" class="card-link btn btn-danger">Back</a>
                        </div>
                    </div>
                </div>
